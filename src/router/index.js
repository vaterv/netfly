    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                path:'queryOrder',
                name:'queryOrder',
                component:()=>import('../components/5_Order/queryOrder.vue')
            },{
                path:'newOrder',
                name:'newOrder',
                component:()=>import('../components/5_Order/newOrder.vue')
            },{
                path:'diliveredOrder',
                name:'diliveredOrder',
                component:()=>import('../components/5_Order/diliveredOrder.vue')
            }
        ]
    }
]
